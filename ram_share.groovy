...
pipeline {
    ...
    stages {
                        ...
                        parameters([
                            ...
                            [
                                ...
                                script: [
                                        ...
                                        script:
                                        """
										return ['ap-northeast-1', 'eu-central-1']
										"""
                                        ]
                                    ]
                            ],
        ...
        */
        stage('Share TGW with novartis aws accounts') {
            steps {
                script {
                    ...
                    sh '''
                    python3 scripts/ram_tgw_share.py --env_type=$NVS_ENV_TYPE --region_name=$RegionName
                    '''
                }
            }
        }
    ...
    post {
        ...
        failure {
            script {
                println "TGW RAM share was failed."
            }
        }
    }
}
