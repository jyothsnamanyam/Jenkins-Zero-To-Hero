...
pipeline {
    ...
    stages {
        ...
        stage('TGW VPC Attachment request Creation') {
            steps {
                script {
                    sh '''
                    python3 scripts/spoke_vpc_tgw_attachment_request.py --env_type=$NVS_ENV_TYPE --region_name=$RegionName --account_type=$ACCOUNT_TYPE --access_type=$SPOKE_ACCESS_TYPE
                    '''
                }
            }
        }
    ...
    post {
        success {
            script {
                ...
                println "spoke vpc tgw attachment was success."
        ...
        failure {
            script {
                println "spoke vpc tgw attachment was failed."
            }
        }
    }
}
