...
pipeline {
    ...
    stages {
         ...
         */
        stage('TGW Spoke VPC existing attachment update.') {
            steps {
                script {
                    ...
                    sh '''
                    python3 scripts/spoke_vpc_existing_attachment.py --environment=$NVS_ENV_TYPE --region_name=$RegionName
                    '''
                }
            }
        }
    ...
    post {
        success {
            script {
                ...
                println "TGW Spoke VPC existing attachment update success."
        ...
        failure {
            script {
                println "TGW Spoke VPC existing attachment update was failed."
            }
        }
    }
}
