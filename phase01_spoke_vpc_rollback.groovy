    ...
    stages {
        ...
        stage('Spoke vpc routing rules.') {
            steps {
                script {
                    sh '''
                    python3 scripts/phase01_spoke_vpc_rollback.py --env_type=$NVS_ENV_TYPE --region_name=$RegionName --account_type=$ACCOUNT_TYPE --access_type=$SPOKE_ACCESS_TYPE
                    '''
                }
            }
        }
    ...
    post {
        success {
            script {
                ...
                println "Phase01 spoke vpc rollback was success."
        ...
        failure {
            script {
                println "Phase01 spoke vpc rollback  was failed."
            }
        }
    }
}
